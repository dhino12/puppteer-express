...
```
cd existing_repo
git remote add origin https://gitlab.com/projectapp3/expressjs/puppteer-expressjs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/projectapp3/expressjs/puppteer-expressjs/-/settings/integrations)
